...
def handle_faq(message):
    bot.send_message(
        ...
        "Нажмите «📥 Пополнить баланс», введите код установки и следуйте инструкции.\n\n"

        "<b>⏱ Сколько времени даётся на внесение крышек?</b>\n"
        "После вашей очереди у вас есть ограниченное время (обычно несколько минут), чтобы внести крышки.\n\n"

        "<b>🤖 Почему бот не отвечает?</b>\n"
        "Иногда возможны задержки из-за соединения или сервера. Попробуйте снова через несколько минут.\n\n"

        "<b>💰 Где посмотреть баланс?</b>\n"
        "Нажмите «🪙 Проверить баланс», и бот покажет актуальную сумму.\n\n"

        "<b>⚠️ Что делать, если возникла ошибка?</b>\n"
        "Попробуйте повторить действие или перезапустить процесс. Если проблема сохраняется — обратитесь к поддержке.",
